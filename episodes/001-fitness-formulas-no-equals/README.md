...
- 尚未归档：最终 v2 导出视频文件、实际抖音链接和发布后数据
- 计划发布时间：工作日 20:30
...
1. 用 [v2 口播](02-script/narration-v2.md) 逐段重新生成七段配音。
2. 对齐七张图，重新识别并校对字幕。
3. 使用新版留白封面，在发布页添加短标题。
4. 导出 v2 并按 [发布材料](06-publishing/publishing.md) 发布。
5. 把最终视频位置、作品链接和 24/72 小时数据写回本文件。
