...
- 当前状态：八组首尾帧已生成；场景 08 因首尾动作跨度过大，已改为轻动作尾帧 v2 并完成视觉检查。
...
| 08 说话太直 | [start](horizontal-v1/08-blunt-speech-start.png) | [v2 subtle end](horizontal-v1/08-blunt-speech-end-v2-subtle.png) |
...
- 场景 08 的 v1 尾帧要求男同事后退捂嘴、背景人物交换眼神，导致图生视频过渡僵硬且路人反应突兀；已移至 [archive/08-blunt-speech-end-v1-overreaction.png](archive/08-blunt-speech-end-v1-overreaction.png)。当前 v2 只让男同事小幅收手，背景人物完全不动。
